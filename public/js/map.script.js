...
//  google map 4 default function custom ========================== //
	...
	if(jQuery('#gmap_canvas4').length){
		function init_map4() {
			var myOptions = {
				zoom: 10,
				center: new google.maps.LatLng(23.791519,90.406954),
				mapTypeId: google.maps.MapTypeId.ROADMAP,
			...
			marker4 = new google.maps.Marker({
				map: map4,
				position: new google.maps.LatLng(23.791519,90.406954),
				optimized: false,
			...
			infowindow4 = new google.maps.InfoWindow({
				content: '<strong>Title</strong><br>House # 57, Road # 13, Block # E, 1213 Dhaka, Bangladesh<br>'
			});

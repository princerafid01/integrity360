...
@section('contents')      
        ...
        <div class="page-content">
            ...
            <div class="section-full p-tb90">
            	<div class="container">
                    <?php $path = $project->image ?>
                    <div class="project-detail-outer bg-top-left bg-parallax bg-center"  data-stellar-background-ratio="0.5"  style="background-image:url({{ Voyager::Image($project->image) }})">
                        <div class="row">
                                        ...
                                        <div class="product-block">
                                            <div class="row">
                                              <div class="col-md-6 col-sm-6 m-b30">
                                                ...
                                                <p>{{ date('l d, Y', strtotime($project->created_at)) }}</p>
                                              </div>
                                              <div class="col-md-6 col-sm-6 m-b30">
